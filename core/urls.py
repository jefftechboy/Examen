...
router.register('HistorialCompras', HistorialComprasViewSet)

urlpatterns = [

    path('eliminar_compras/', eliminar_compras, name='eliminar_compras'),
    path('password_reset/', auth_views.PasswordResetView.as_view(template_name='inicio.html'), name='password_reset'),
    path('password_reset/done/',auth_views.PasswordResetDoneView.as_view(template_name='inicio.html'),name='password_reset_done'),
    path('reset/<uidb64>/<token>/',auth_views.PasswordResetConfirmView.as_view(template_name='inicio.html'),name='password_reset_confirm'),
    path('reset/done/',auth_views.PasswordResetCompleteView.as_view(template_name='inicio.html'),name='password_reset_complete'),
